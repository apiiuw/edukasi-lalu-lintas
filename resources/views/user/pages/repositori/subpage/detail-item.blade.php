...
<div class="pt-28 px-4">
    <div class="w-full h-full bg-cover bg-center" style="background-image: url('/img/background/bg-jr-gray.png');">
        <div class="flex flex-col items-center mb-20">
            ...
            <!-- Buttons -->
            <div class="flex flex-col lg:flex-row gap-4 mt-4 w-full justify-center px-4">
                <a href="{{ Storage::url($item->pdf) }}" target="_blank" class="bg-blueJR text-white px-6 py-2 rounded-lg flex items-center justify-center gap-2">
                    <span><i class="fa-solid fa-eye"></i></span> Lihat Detail
                </a>
                <a href="{{ Storage::url($item->pdf) }}" download="Edulantas_Buku {{ $item->judul }}.pdf" class="bg-blueJR text-white px-6 py-2 rounded-lg flex items-center justify-center gap-2">
                    <span><i class="fa-regular fa-circle-down"></i></span> Unduh Buku
                </a>

                <a id="shareBtn" class="bg-blueJR hover:cursor-pointer text-white px-6 py-2 rounded-lg flex items-center justify-center gap-2">
            ...
            <script>
                document.getElementById("shareBtn").addEventListener("click", function() {
                    let rawUrl = window.location.href; // untuk ditampilkan dalam teks
                    let encodedUrl = encodeURIComponent(window.location.href); // untuk query string
                    ...
                    document.getElementById("facebookShare").href = `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}&quote=${encodeURIComponent(shareText)}`;
            ...
            <!-- Cover Image -->
            <div class="mt-6 w-full lg:w-4/12 px-4">
            ...
            <!-- Buttons -->
            <div class="flex flex-col lg:flex-row px-4 w-full justify-center gap-4 mt-4">
                <a href="{{ $item->youtube_url }}" target="_blank" class="bg-red-500 text-white px-6 py-2 rounded-lg flex items-center justify-center gap-2">
                    <span><i class="fa-solid fa-eye"></i></span> Tonton di Youtube
                </a>
                <a id="shareBtn" class="bg-red-500 hover:cursor-pointer text-white px-6 py-2 rounded-lg flex items-center justify-center gap-2">
                    <span><i class="fa-solid fa-share"></i></span> Bagikan
                </a>
            </div>
